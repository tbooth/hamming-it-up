...
def timming_preprocessed_time():
    SETUP_CODE_PREPROCESSED_BINARY = '''
from timming import string_to_npm, hamming_dist_calc
from random import choice
from __main__ import string_generator, length_of_strings, number_of_strings
list_of_binary_strings1 = [string_to_npm(string_generator(length_of_strings)) for i in range(number_of_strings)]
list_of_binary_strings2 = [string_to_npm(string_generator(length_of_strings)) for i in range(number_of_strings)]'''
